...
const AddBlog = () => {
  ...
  return (
    <form onSubmit={onSubmitHandler} className="flex-1 bg-blue-50/50 text-gray-600 h-full overflow-scroll">
      <div className="bg-white w-full max-w-xl p-4 md:p-10 sm:m-10 shadow rounded">
        ...
        <button disabled={isAdding} className="mt-8 w-40 h-10 bg-primary text-white 
        rounded cursor-pointer text-sm" type="submit">{isAdding ? 'Adding...' : 'Add Blog'}</button>
